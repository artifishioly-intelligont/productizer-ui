...
<div class="container">
    <div class="jumbotron slider">
        <div class="@if (count($errors) == 0) slide-1 @else slide-2 @endif">
            ...
            <p class="lead">The Productizer allows you to select a feature from an Ordnance Survey image that you upload, and will automatically, using complex machine learning algorithms, find the rest of those features within the image.</p>
            <hr class="m-y-2">
